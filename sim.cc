...
int main (int argc, char *argv[]) {
   ...
   if (params.L2_SIZE !=0){
      L2 = GenericCache(params.BLOCKSIZE, params.L2_SIZE, params.L2_ASSOC, NULL);
      L1 = GenericCache(params.BLOCKSIZE, params.L1_SIZE, params.L1_ASSOC, &L2);
   }
   else{
      L1 = GenericCache(params.BLOCKSIZE, params.L1_SIZE, params.L1_ASSOC, NULL);
   }
